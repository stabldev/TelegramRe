...
export const ChatHeader: Component = () => {
	...
	return (
		<div class="flex h-[3.75vw] select-none items-center justify-between border-b-[0.1vw] border-black/50 bg-stone-900 px-[1vw]">
			<button
				onClick={toggleShowSidebar}
			...
			>
				...
				/>
				<div class="flex flex-col items-start gap-[0.25vw] leading-none">
