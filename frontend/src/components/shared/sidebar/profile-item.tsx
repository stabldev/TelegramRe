...
export const ProfileItem = (props: ProfileItemProps) => {
	...
	return (
		<A
			...
			activeClass="bg-blue-500 hover:bg-blue-500 before:absolute before:left-0 before:w-[0.35vw] before:h-[2.5vw] before:bg-white before:rounded-full before:rounded-l-none"
		>
			<img
